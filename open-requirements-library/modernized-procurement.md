...
### Assumptions
All artifacts, research, processes, flows, etc. will be shared in an open, public repository.
Research insights will be anonymized and will not be attributed back to individuals.
...
**Sprint Zero**
To ensure schedule and budget are adhered to, time will be scheduled initially to set alignment before the official first discovery week begins. Typically, a sprint zero can be one half of the normal sprint cycle (10 business days).
...
The findings of Phase One will ultimately determine the best approach to Phase Two.
Period of Performance: 2 two-week sprints
